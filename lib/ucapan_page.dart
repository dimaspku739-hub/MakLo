// ucapan_page.dart - Theme: Biru Muda
import 'dart:convert';
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.person, color: accentBlue, size: 20),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: softGrey.withOpacity(0.5)),
                      prefixIcon: const Icon(Icons.edit_note, color: accentBlue, size: 20),
                      border: InputBorder.none,
                      contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
                    ),
                  ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.card_giftcard_rounded, size: 70, color: accentBlue),
                            ),
                            const SizedBox(height: 20),
                            const Text(
                              'Belum ada ucapan',
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              const Icon(Icons.thumb_up_alt_outlined, color: accentBlue, size: 16),
                                              const SizedBox(width: 6),
                                              Text(
                                                '${ucapan.likes}',
                                                style: const TextStyle(color: accentBlue, fontSize: 12, fontWeight: FontWeight.w600),
                                              ),
                                            ],
                                          ),
                                        ),
