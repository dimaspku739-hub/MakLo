...
class _AttackPanelState extends State<AttackPanel> with TickerProviderStateMixin {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Divider(color: accentBlue, thickness: 0.6),
              ...
              _buildInputCard(
                ...
                child: TextField(
                  ...
                  cursorColor: isIcmp ? Colors.grey : accentBlue,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 6,
                    shadowColor: accentBlue.withOpacity(0.6),
                  ),
                ),
              ),
            ],
  ...
  Widget _buildInputCard({required IconData icon, required String title, required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: accentBlue.withOpacity(0.5), width: 1),
        boxShadow: [
          BoxShadow(
  ...
  InputDecoration _inputStyle(String hint, {bool isIcmp = false}) {
    return InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(color: isIcmp ? Colors.grey : accentBlue),
      filled: true,
      fillColor: primaryDark,
      contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(color: isIcmp ? Colors.grey : accentBlue),
        borderRadius: BorderRadius.circular(16),
      ),
