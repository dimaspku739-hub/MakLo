...
class _InstagramDownloaderPageState extends State<InstagramDownloaderPage> {
  ...
  final Color primaryBlue = const Color(0xFF1A3A5C);
  final Color accentBlue = const Color(0xFF64B5F6);
  final Color lightBlue = const Color(0xFF4FC3F7);
  final Color primaryWhite = Colors.white;
  final Color accentGrey = const Color(0xFF90CAF9);
  final Color cardDark = const Color(0xFF0A1628);
                ...
                Expanded(
                  child: ClipRRect(
                    ...
                    child: isVideo
                      ...
                      children: [
                        Image.network(
                          ...
                          errorBuilder: (_, __, ___) => Container(
                            ...
                            child: Icon(Icons.videocam, color: lightBlue),
                          ),
                        ),
                        Positioned(
                          bottom: 8,
                      ...
                      errorBuilder: (_, __, ___) => Container(
                        color: Colors.black.withOpacity(0.5),
                        child: Icon(Icons.photo, color: lightBlue),
                      ),
                    ),
                  ),
                ),
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.camera_alt, color: lightBlue),
